...
<body class="bg-dark text-white">
  ...
  <div class="container">
    <div class="col-md-6 col-sm-8 offset-sm-2 offset-md-3 my-5 text-center">
      
      <?php foreach($karte as $key=>$karta): ?>
          
          <ul style = "padding-left:0; list-style: none;">
          <p style = "text-align: center;">Narudžbenica #<?php echo $key + 1; ?></p>
      ...
      <a href="index.php" class="mt-2 center"  style="display: inline-block; color:white;">Nazad</a>
